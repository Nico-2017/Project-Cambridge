...
function preload() {
    ...
    game.load.audio("newSound","../assets/Hello.wav");
}
...
function create() {
    ...
    tText = game.add.text(620, 20, "Some Text",
...
function changeText() {
  ...
  if(score > 4)
     tText.destroy(game.add.text(620, 20, "Some Text",
         {font: "30px Arial", fill: "#FFFFFF"}));
     // game.add.text(620, 20, "Some Text",
      //   {font: "30px Arial", fill: "#FFFFFF"});
